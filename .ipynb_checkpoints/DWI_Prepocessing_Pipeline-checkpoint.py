...
import shutil
import argparse
os.chdir('/mnt/c/Users/calia/Documents/Scripts/Test_area/7352613/')
path = os.chdir('/mnt/c/Users/calia/Documents/Scripts/Test_area/7352613/')
path = os.getcwd()
...
# PE_1 = ('/mnt/c/Users/calia/Documents/scripts/Test_area/7352613/DICOM_DWI_LR_BIC_20140722165645_17.nii')
# PE_2 = ('/mnt/c/Users/calia/Documents/scripts/Test_area/7352613/DICOM_DWI_RL_BIC_20140722165645_19.nii')
...
for file in files(path):
    if file == direction_1_string:
        # print(os.path.join(path, file))
        dir_1_list.append(file)

for file2 in files(path):
    if file2 == direction_2_string:
        # print(os.path.join(path, file))
